  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-2">
        ...
        <span className="text-gray-500 text-sm">{snippet.createdAt}</span>
      </div>
      ...
      <div className="bg-[#252525] border border-gray-700 rounded-lg p-3 mb-4">
      ...
      <div className="flex items-center justify-between text-sm">
        ...
        <div className="flex items-center gap-1">
          <Heart className={`h-4 w-4 ${snippet.isLiked ? "fill-red-500 text-red-500" : "text-gray-400"}`} />
