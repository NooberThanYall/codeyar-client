    ...
    <main className="w-screen h-screen flex justify-center overflow-x-hidden items-center p-4 bg-[#121212] font-inter">
      ...
      <div className="bg-[#1e1e1e] p-8 sm:p-10 rounded-2xl shadow-2xl w-full max-w-md border border-gray-700">
        ...
        <form className="space-y-4">
          ...
          <textarea
            name="code"
            className="w-full pr-5 pl-4 h-96 py-3 bg-gray-800 text-gray-600 rounded-lg border border-gray-700 focus:outline-none focus:ring-2 focus:ring-red-600 focus:border-transparent transition-all duration-50 text-right"
            dir="ltr"
          ...
          <button
            ...
            onClick={(e) => {
              e.preventDefault();
              newSnippetSubmit(state, setState, router);
            }}
